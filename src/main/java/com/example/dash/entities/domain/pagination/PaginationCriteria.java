...
public class PaginationCriteria
{
	...
	public String getFilterByClause()
	{
		...
		if (!isFilterByEmpty())
		{
			final Iterator<Entry<String, String>> fbit = filterBy.getMapOfFilters().entrySet().iterator();

			while (fbit.hasNext())
			{

				final Map.Entry<String, String> pair = fbit.next();
				...
				if (null == fbsb)
				{
					...
					fbsb.append(SPACE).append(BRKT_OPN).append(pair.getKey()).append(LIKE_PREFIX).append(pair.getValue())
				...
				else
				{
					...
					fbsb.append(filterBy.isGlobalSearch() ? OR : AND).append(BRKT_OPN).append(pair.getKey()).append(LIKE_PREFIX)
	...
	public String getOrderByClause()
	{
		...
		if (!isSortByEmpty())
		{
			final Iterator<Entry<String, SortOrder>> sbit = sortBy.getSortBys().entrySet().iterator();

			while (sbit.hasNext())
			{
				final Map.Entry<String, SortOrder> pair = sbit.next();
				if (null == sbsb)
				{
